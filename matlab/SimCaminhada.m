...
posturas = [
    ...
    0.0   0.2   0.0   0.0;   % pe esquerdo levanta
   -0.3   0.2   0.0   0.0;   % perna esquerda recua
   -0.3   0.0   0.0   0.0;   % pe esquerdo abaixa
    0.0   0.0   0.0   0.0;   % perna esquerda volta neutro
    0.0   0.0   0.0   0.2;   % pe direito levanta
    0.0   0.0  -0.3   0.2;   % perna direita recua
    0.0   0.0  -0.3   0.0;   % pe direito abaixa
